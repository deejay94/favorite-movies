...
var config = {
  apiOrigins: {
    production: 'https://deejay94.herokuapp.com/'
  }
};
...
var update = function update(data, newId) {
  return $.ajax({
...
var faveMovieEvents = __webpack_require__(17);
...
var onAddFave = function onAddFave(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.create(data).then(ui.createFaveSuccess).catch(ui.createFaveFailure);
};

var onGetFaves = function onGetFaves(event) {
  event.preventDefault();
  api.index().then(ui.getFavesSuccess).then(function () {
...
var onDestroy = function onDestroy(event) {
  event.preventDefault();
  var data = $(this).parent().parent().data('id');
  api.destroy(data).then(ui.deleteFaveSuccess).catch(ui.deleteFavefailure);
};
...
var showFavesTemplate = __webpack_require__(19);

var createFaveSuccess = function createFaveSuccess(data) {
  $('#message4').text('You have successfully added movie to your list').show().fadeOut(1800);
  $('.fave-movie').empty();
  $('.movie-info').trigger('reset');
};

var createFaveFailure = function createFaveFailure(data) {
  $('#message4').text('You have NOT successfully added movie to your list').show();
};

var getFavesSuccess = function getFavesSuccess(data) {
  if (data.favorite_movies.length === 0) {
    $('#message4').text('You have not created any faves to display').show();
  } else {
    var showFavesHtml = showFavesTemplate({ favorite_movies: data.favorite_movies });
    $('.fave-movie').remove();
...
var onEditFave = function onEditFave(event) {
  event.preventDefault();
  var id = $(this).parent().parent().attr('data-id');
  var title = $(this).parent().siblings()[1];
  var genre = $(this).parent().siblings()[2];
  var comment = $(this).parent().siblings()[3];
  console.log(id);
  console.log(title);
...
var onConfirmSave = function onConfirmSave(id, title, genre, comment) {
  var newTitle = $(title).text();
  var newGenre = $(genre).text();
  ...
  api.update(data, id).then(updateFaveSuccess).catch(updateFaveFailure);
};

var getFavesFailure = function getFavesFailure() {
  $('#message4').text('You have NOT successfully displayed favorite movies').show();
};

var updateFaveSuccess = function updateFaveSuccess() {
  $('#message4').text('You have successfully updated a favorite movie');
  api.index().then(getFavesSuccess).catch(getFavesFailure);
  $('.update-fave').trigger('reset');
};

var updateFaveFailure = function updateFaveFailure() {
  $('#message4').text('You have NOT successfully updated a favorite movie');
};

var deleteFaveSuccess = function deleteFaveSuccess() {
  $('#message4').show().text('Delete success!');
  api.index().then(getFavesSuccess).catch(getFavesFailure);
};

var deleteFavefailure = function deleteFavefailure() {
...
module.exports = {
  getFavesSuccess: getFavesSuccess,
  getFavesFailure: getFavesFailure,
  failure: failure,
  updateFaveFailure: updateFaveFailure,
  updateFaveSuccess: updateFaveSuccess,
  deleteFaveSuccess: deleteFaveSuccess,
  deleteFavefailure: deleteFavefailure,
  createFaveSuccess: createFaveSuccess,
  createFaveFailure: createFaveFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"getfave\">\n      <table class=\"fave-movie\">\n        <tbody>\n          <tr>\n            <th>Id</th>\n            <th>Title </th>\n            <th>Genre </th>\n            <th>Comment </th>\n          </tr>\n\n        <tr data-id=\""
    ...
    + "</td>\n          <td>\n          <button class=\"editfave\">Edit Movie</button>\n          <button class=\"savefave hidden\">Save Changes</button>\n          <button class=\"remove-fave\">Remove Movie</button>\n          <button class=\"delete-fave\">Delete movie</button>\n        </td>\n        </tr>\n      </tbody>\n      </table>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class=\"allfave\">\n\n\n\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.favorite_movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
